...
<div class="contents1"> 
	...
	<form action="board_write_process.jsp" method="post" name="boardForm"> <!-- 수정된 부분: action 속성에 데이터 처리를 위한 JSP 파일 경로 지정 -->
		...
		<!--게시판-->
			...
			<div class="btn_area">
				...
				<div class="align_right">			
					<input type="submit" value="쓰기" class="btn_write btn_txt01" style="cursor: pointer;" /> <!-- 수정된 부분: 버튼 타입을 submit으로 변경 -->
				</div>	
			</div>	
			<!--//게시판-->
		</div>
