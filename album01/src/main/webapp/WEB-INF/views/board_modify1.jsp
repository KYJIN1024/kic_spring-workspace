	...
	<form action="" method="post" name="">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th>이메일</th>
					<td colspan="3"><input type="text" name="mail1" value="<%=mail1() %>" class="board_view_input_mail"/> @ <input type="text" name="mail2" value="<%= board.getMail2() %>" class="board_view_input_mail"/></td>
				</tr>
				</table>
			</div>
